...
// onStockSelect is a function we get from App.jsx to handle clicks
export default function Dashboard({ onStockSelect }) {
  ...
  const handleSearchChange = async (event) => {
    ...
    if (newSearchTerm.length > 1) {
      ...
      try {
        ...
        // This is the API call to our backend's search feature
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      {/* Main Content (Portfolio and Navigation) */}
      <main className="p-8">
